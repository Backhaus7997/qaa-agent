...
function buildStateFrontmatter(bodyContent, cwd) {
  ...
  // Extract per-stage status from STATE.md body (QAA pipeline tracking)
  ...
  // QAA pipeline-aware status normalization
  ...
  const fm = { qaa_state_version: '1.0' };
